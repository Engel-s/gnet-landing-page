export const teamMembers = [
  {
    name: "Elking Gallegos",
    role: "Project Manager / Full Stack",
    description:
      "Encargado de coordinar el desarrollo del proyecto, apoyar en la programación, diseño de interfaces y estructura de base de datos.",
    image: "/team/Elking.jpg",
